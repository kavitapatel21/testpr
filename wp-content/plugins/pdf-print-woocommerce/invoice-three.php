...
<table class="order-data-addresses">
	<tbody>
			...
			<td class="address billing-address" width="30%" style="margin-top:20px;">
				<table class="totals" style="margin-top:20px;width:100%;">
					<tfoot>
						...
						<?php $cus_form_info_ship_issue_date  = get_post_meta( $order_id[0]->order_id, '_cus_form_info_ship_issue_date'); 
							if($cus_form_info_ship_issue_date [0]){
							?>
							<tr>
								<th class="description textcenter">発行日</th>
								<td class="price" style="border:1px solid #ccc;"><span class="invoice-date"><?php echo date_i18n(wc_date_format(), strtotime($cus_form_info_ship_issue_date[0])); ?></span></td>
							</tr>
							<?php }else{ ?>
		...
		<tr style="vertical-align: baseline;">
			<td class="address billing-address">
				<table class="totals remove-border" border="0" style="width:100%">
					<tfoot>
						<tr>
							<td style="width:50%;border:0;">
								<table class="totals remove-border" border="0" style="width:100%;">
									<tfoot>
										...
										<tr>
											<th style="width:20%" class="description textcenter">注文日</th>
											<?php $post = get_post($order_id[0]->order_id);?>
											<td class="price"><span class="invoice-date"><?php echo date_i18n(wc_date_format(), strtotime($post->post_date)); ?>													</span>
											</td>
										</tr>
										...
										<!-- <tr>
											...
											<td class="price"><span class="invoice-date"><?php //echo $key_1_values[0][0]['tracking_provider']; ?></span></td>
										</tr> -->
										<?php //} ?>
										<!-- -->
										<tr>
							...
							<td style="width:50%;border:0;">
								<table class="totals remove-border" border="0">
								<tfoot>
				...
				<table class="totals" style="margin-top: 10px;margin-bottom:10px;" cellpadding="0" cellspacing="0">
					<tfoot>
						<tr>
							<th style="width:20%;" class="description textcenter">合計金額</th>
...
<table style="width:100%;margin-top: 25px;">
	<thead>
		...
		<tr>
			...
			<?php 
			$cus_form_info_ship_issue_detail = get_post_meta( $order_id[0]->order_id, '_cus_form_info_ship_issue_detail');
			echo $cus_form_info_ship_issue_detail[0];
			?>
			</td>
		</tr>		
	</thead>
