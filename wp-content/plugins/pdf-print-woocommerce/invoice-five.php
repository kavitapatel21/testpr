...
<table class="order-data-addresses">
	<tbody>
				...
				<table class="totals" style="margin-top:20px;width:100%;">
					<tfoot>
						<tr>
							...
							<?php
						$cus_form_info_issue_date = get_post_meta($order_id[0]->order_id, '_cus_form_info_issue_date'); 
						if($cus_form_info_issue_date[0]){
						?>
						<tr>
							<th class="description" style="text-align:center;">発行日</th>
							<td class="price" style="border:1px solid #ccc;"><span class="invoice-date"><?php echo date_i18n(wc_date_format(), strtotime($cus_form_info_issue_date[0])); ?></span></td>
						</tr>
						<?php }else{?>
						<tr>
							<th class="description" style="text-align:center;">発行日</th>
							<td class="price" style="border:1px solid #ccc;">
							<span class="invoice-date">
							<?php $current_date = date('Y-m-d');?>
						<?php echo date_i18n(wc_date_format(), strtotime($current_date)); ?>
							</span></td>
						</tr>
						<?php } ?>							
					</tfoot>
		...
		<tr>
			<td class="address billing-address">
				<table class="totals remove-border" style="width:75%" border="0">
					<tfoot>
						<tr>
							<th style="width:10%" class="description textcenter">件名</th>
						...
						<tr class="payment-method">
							<th style="width:10%" class="description textcenter">決済方法</th>
...
<table style="width:100%;margin-top: 25px;">
	<thead>
		...
		<!--<tr>
			<td class="footer_th" style="text-align:left; background-color: #fff; color:black; border:none;">＊お振込手数料はご負担願います</td>
		</tr>	-->	
		<tr>
			<td class="footer_th" style="text-align:left; background-color: #fff; color:black; border:none;">
			<?php 
