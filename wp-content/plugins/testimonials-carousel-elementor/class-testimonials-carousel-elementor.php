...
final class Testimonials_Carousel_Elementor
{
  ...
  public function __construct()
  {
    ...
    add_action('wp_ajax_nopriv_save_testimonials_option', [$this, 'save_testimonials_option_callback']);
  }
  ...
  public function init()
  {
    ...
    wp_enqueue_style('swiper', plugins_url('/assets/css/swiper.min.css', TESTIMONIALS_CAROUSEL_ELEMENTOR));
  }
