...
class TestimonialsCarousel_Gallery_Coverflow extends Widget_Base
{
  ...
  public function __construct($data = [], $args = null)
  {
    ...
    wp_register_style('testimonials-gallery-carousel', plugins_url('/assets/css/testimonials-gallery-carousel.min.css', TESTIMONIALS_CAROUSEL_ELEMENTOR), [], '7.1.0');
                    ...
                    <div class="quote">
                      <div class="quote-wrapper">
                        <?php if (!empty(wp_kses($item['slide_icon_link']['url'], []))) { ?>
                          <a <?php if (wp_kses($item['slide_icon_link']['is_external'], [])
                          === 'on') { ?> target="_blank"
                            <?php } if (wp_kses($item['slide_icon_link']['nofollow'], [])) { ?>rel="nofollow"<?php } ?>
                            href="<?php echo wp_kses($item['slide_icon_link']['url'], []); ?>"
                      ...
                      <div class="slide-content">
                        <div class="slide-description" style="line-height: 22px;-webkit-line-clamp: <?php echo $settings['show_line_text']; ?>">
