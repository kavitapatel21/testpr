...
class TestimonialsCarousel extends Widget_Base
{
  ...
  public function __construct($data = [], $args = null)
  {
    ...
    wp_register_style('swiper', plugins_url('/assets/css/swiper-bundle.min.css', TESTIMONIALS_CAROUSEL_ELEMENTOR), [], '7.1.0');
    wp_register_style('testimonials-carousel', plugins_url('/assets/css/testimonials-carousel.min.css', TESTIMONIALS_CAROUSEL_ELEMENTOR), [], '7.1.0');
    wp_register_script('swiper', plugins_url('/assets/js/swiper-bundle.min.js', TESTIMONIALS_CAROUSEL_ELEMENTOR), [], '7.1.0', true);
    ...
    if (get_plugin_data(ELEMENTOR__FILE__)['Version'] >= "3.5.0") {
      wp_register_script('testimonials-carousel-widget-handler', plugins_url('/assets/js/testimonials-carousel-widget-handler.min.js', TESTIMONIALS_CAROUSEL_ELEMENTOR), ['elementor-frontend'], '7.1.0', true);
    } else {
      wp_register_script('testimonials-carousel-widget-handler', plugins_url('/assets/js/testimonials-carousel-widget-old-elementor-handler.min.js', TESTIMONIALS_CAROUSEL_ELEMENTOR), ['elementor-frontend'], '7.1.0', true);
    }
  }
  ...
  {
    return __('Testimonial Carousel with Rating', 'testimonials-carousel-elementor');
  }
  ...
  {
    return 'icon-slider-top-info-icon';
  }
  ...
  protected function _register_controls()
  {
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .slide-block' => 'border-bottom-width: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'type'      => Controls_Manager::COLOR,
        'selectors' => [
          '{{WRAPPER}} .slide-block' => 'border-bottom-color: {{VALUE}};',
        ],
      ]
    );
    $this->end_controls_section();
    ...
    $this->add_responsive_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .slide-basic-info' => 'justify-content: {{VALUE}}',
        ],
      ]
    );
    $this->add_responsive_control(
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .slider-modal .slide-block' => 'border-bottom-width: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'type'      => Controls_Manager::COLOR,
        'selectors' => [
          '{{WRAPPER}} .slider-modal .slide-block' => 'border-bottom-color: {{VALUE}};',
        ],
      ]
    );
    $this->add_control(
    ...
    $this->add_responsive_control(
      ...
      [
        ...
        'default'   => 'row',
        'selectors' => [
          '{{WRAPPER}} .slider-modal-container .slide-block' => 'flex-direction: {{VALUE}}',
        ],
        'separator' => 'before',
      ]
    );
    ...
    $this->add_responsive_control(
      ...
      [
        ...
        'default'   => 'left',
        'selectors' => [
          '{{WRAPPER}} .slider-modal-container .slide-icons' => 'text-align: {{VALUE}}',
        ],
        'separator' => 'before',
      ]
    );
    ...
    $this->add_responsive_control(
      ...
      [
        ...
        'default'   => 'space-between',
        'selectors' => [
          '{{WRAPPER}} .slider-modal-container .slide-basic-info' => 'justify-content: {{VALUE}}',
        ],
      ]
    );
    $this->add_responsive_control(
    ...
    $this->add_control(
      ...
      [
        ...
        'default'      => 'outside',
        'options'      => [
          'inside'  => esc_html__('Inside', 'testimonials-carousel-elementor'),
          'outside' => esc_html__('Outside', 'testimonials-carousel-elementor'),
        ],
        'prefix_class' => 'swiper-arrows-position-',
      ]
    );
    ...
    $this->add_control(
      'arrows_background',
      [
        'label'     => esc_html__('Arrows background', 'testimonials-carousel-elementor'),
        'type'      => Controls_Manager::COLOR,
        'selectors' => [
          '{{WRAPPER}} .mySwiper .swiper-button-prev, {{WRAPPER}} .mySwiper .swiper-button-next' => 'background: {{VALUE}};',
        ],
      ]
    );
    ...
    $this->add_control(
      ...
      [
        'label'     => esc_html__('Arrows hover background', 'testimonials-carousel-elementor'),
        'type'      => Controls_Manager::COLOR,
        'selectors' => [
          '{{WRAPPER}} .mySwiper .swiper-button-prev:hover, {{WRAPPER}} .mySwiper .swiper-button-next:hover' => 'background: {{VALUE}};',
        ],
      ]
    );
  ...
  protected function render()
  {
    ...
    if ($settings['slide']) {
      ...
      <section class="swiper mySwiper myTestimonials <?php if (
              ...
              <div class="block-shadow slider-container-block-background">
                ...
                <div class="slide-content">
                  <div class="slide-description"
                       style="line-height: 22px;-webkit-line-clamp: <?php echo $settings['show_line_text']; ?>"><?php echo $item['slide_content']; ?></div>
