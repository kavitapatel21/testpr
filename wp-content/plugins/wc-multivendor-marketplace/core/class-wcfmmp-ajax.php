...
class WCFMmp_Ajax {
    ...
    $store_list_markers = '';
        ...
        foreach($branches as $store) {
          if( $count > 1 && apply_filters('wcfmmp_vendor_restrict_to_single_map_marker', true) ) continue;
          $store_user      = wcfmmp_get_store( $store_id );
          $store_info      = $store_user->get_shop_info();
          $store_name      = $store['display_name'] ?? wcfm_get_vendor_store_name( $store_id );
          ...
          if( $store_address && ( ( $store_info['store_hide_address'] == 'yes' ) || !wcfm_vendor_has_capability( $store_id, 'vendor_address' ) ) ) {
            $store_address = '';
				  ...
				  $info_window_content =  apply_filters( 'wcfmmp_map_store_info', "<div class='wcfm_map_info_wrapper'>" .
                                                                        ...
                                                                        apply_filters( 'wcfmmp_map_additional_store_info', '', $store, $store_id ) . 
																																				"</div>" .
