...
class Str {
	...
	public static function rtrim_by_string( string $data, $delimiter = '.' ) {
		return self::separed_supplement_of_last_part( $data, $delimiter, $data );
	}
	...
	public static function classes( $args = [], $include_class_arg_name = false ) {
		$final_class_arr = [];
	...
	public static function classes_e( $args = [], $include_class_arg_name = false ) {
