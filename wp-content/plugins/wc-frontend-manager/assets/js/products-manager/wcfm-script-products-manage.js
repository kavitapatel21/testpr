...
jQuery( document ).ready( function( $ ) {
  ...
  $('.wcfm-tabWrap .page_collapsible').collapsible({
	...
	$('.policy_override_ele').change(function() {
	  if($(this).is(':checked')) {
	  	$(this).parent().find('.non_policy_override_ele').removeClass('wcfm_custom_hide');
		$(this).parent().find('.non_policy_override_ele.wcfm_wpeditor').parents('.wp-editor-wrap').removeClass('wcfm_custom_hide');
	  	resetCollapsHeight($('#wcfm_policy_override'));
	  } else {
	  	$(this).parent().find('.non_policy_override_ele').addClass('wcfm_custom_hide');
		$(this).parent().find('.non_policy_override_ele.wcfm_wpeditor').parents('.wp-editor-wrap').addClass('wcfm_custom_hide');
	  }
	}).change();
