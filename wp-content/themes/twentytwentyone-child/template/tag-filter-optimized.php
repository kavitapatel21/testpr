...
<?php
/*
 * Template Name: Tag-filtered-optimized
 * description: >-
        ...
        <div class="row mt-5">
            ...
            $loop = new WP_Query($args); ?><?php
                                            ...
                                            while ($loop->have_posts()) : $loop->the_post();
                                                ...
                                                $firstPosts[] = $post_id;
                                            ?>
            <div class="col-12 wow fadeInUp mb-3 post" data-wow-duration="2s">
...
<script>
    ...
    var postsPerPage = 7; // Number of posts to show per page
    ...
    // Function to show/hide posts based on pagination
    ...
    jQuery('.tag-list a').click(function (e) {
        e.preventDefault();
        var tag = $(this).data('tag');
        $posts.hide(); // Hide all posts

        if (tag === 'all') {
            showPosts(currentPage); // Show posts based on the current page
        } else {
            jQuery('.post[data-tags*="' + tag + '"]').each(function () {
                if (currentPage === 1) {
                    jQuery(this).show();
                } else {
    ...
    $('.pagination').twbsPagination({
        ...
        visiblePages: 5, // Number of pagination links to display
