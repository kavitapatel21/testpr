...
<?php
/*
 * Template Name: Gym-member-Blog-page
 * description: >-
...
// Get the tags for the specific custom post type
/* $tags = get_terms('gym-member-tags', array('taxonomy' => 'gym-member-tags', 'hide_empty' => false));
...
<div class="container">
    <div class="buttons mt-5">
        <div class="scrollbar">
            ...
            <?php
            // Get the tags for the specific custom post type
            $tags = get_terms('gym-tags', array('taxonomy' => 'gym-tags', 'hide_empty' => false));
